...
import ua.nure.stanchyk.lab3.adapters.PlayListAdapter;
import ua.nure.stanchyk.lab3.models.Audio;
import ua.nure.stanchyk.lab3.models.PlaybackStatus;
import ua.nure.stanchyk.lab3.services.AudioPlayerService;
import ua.nure.stanchyk.lab3.utils.ProgressUtils;
import ua.nure.stanchyk.lab3.utils.StorageUtil;
...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    protected void onPause() {
        if(_player != null) {
            if (_isPaused) {
                _player.buildNotification(PlaybackStatus.PAUSED);
            } else {
                _player.buildNotification(PlaybackStatus.PLAYING);
            }
        }
        super.onPause();
    }
    ...
    private void initViewElements() {
        _currentAudioTitle = this.findViewById(R.id.audioTitle);
        _progressBar = this.findViewById(R.id.audioProgressBar);
        _shuffleBtn = this.findViewById(R.id.shuffleBtn);
        _prevBtn = this.findViewById(R.id.prevBtn);
        _nextBtn = this.findViewById(R.id.nextBtn);
        _repeatBtn = this.findViewById(R.id.repeatBtn);
        _playPauseBtn = this.findViewById(R.id.playPauseBtn);
        _audioTime = this.findViewById(R.id.audioTime);

        _adapter = new PlayListAdapter(this, R.layout.playlist_item, _audioList);
        ListView _listView = findViewById(R.id.list);
    ...
    private void updateCurrentAudioView() {
        _currentAudioTitle.setText(String.format("%s - %s", _currentTrack.getTitle(), _currentTrack.getArtist()));
        updateProgressBar();
    }
        ...
        _shuffleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (_shuffleAudio) {
                    ...
                    _shuffleBtn.setImageTintList(ContextCompat.getColorStateList(MainActivity.this, R.color.colorNotChosen));
                }
            }
        });
    }
        ...
        _repeatBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (_repeatAudio) {
                    ...
                    _repeatBtn.setImageTintList(ContextCompat.getColorStateList(MainActivity.this, R.color.colorNotChosen));
                }
            }
        });
    }
    ...
    private Runnable mUpdateTimeTask = new Runnable() {
        public void run() {
            ...
            _audioTime.setText(String.format("%s / %s", ProgressUtils.milliSecondsToTimer(currentDuration), ProgressUtils.milliSecondsToTimer(totalDuration)));

            int progress = ProgressUtils.getProgressPercentage(currentDuration, totalDuration);
